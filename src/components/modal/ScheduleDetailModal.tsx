...
export const ScheduleDetailModal = () => {
  ...
  return (
    <div aria-label="schedule-detail-modal" className="h-full">
      <div className="flex flex-col gap-4 p-6 z-10 bg-white max-w-[400px] h-auto rounded-lg shadow-lg fixed flex-wrap top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 border border-gray-300">
        <h2 className="text-lg font-semibold text-gray-800 break-words w-5/6">
